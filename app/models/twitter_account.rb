class TwitterAccount < ActiveRecord::Base
  attr_accessible :active, :oauth_authorize_url, :oauth_token, :oauth_token_secret, :oauth_token_verifier, :stream_url, :user_id
  # attr_accessible :title, :body
  belongs_to :user

  CONSUMER_KEY = 'BncmPMfYUMm279RWCHbaSw'
  CONSUMER_SECRET = 'ZJDvH8yWDr1G2C4OjVNbR8EyCEDDMl2MdZwf8Umd5g'
